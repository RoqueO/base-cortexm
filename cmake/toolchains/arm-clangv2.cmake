...
if(ARM_GCC)
    ...
    # execute_process(
    #     COMMAND ${ARM_GCC} ${ARCH_FLAGS} ${ARM_GCC_FLAG}
...
set(CMAKE_CXX_FLAGS "${COMMON_FLAGS} -std=c++17 -fno-exceptions -fno-rtti -Wall -Wextra" CACHE INTERNAL "")
...
if(ARM_LIBGCC)
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} ${ARM_LIBGCC}")
endif()
